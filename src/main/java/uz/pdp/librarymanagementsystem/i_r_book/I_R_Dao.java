...
public class I_R_Dao {
    ...
    public static List<I_R_book> getList() {
        ...
        try (
            ...
            while (resultSet.next()) {
                ...
                Type listType = new TypeToken<Set<uz.pdp.librarymanagementsystem.books.Book>>() {
                }.getType();
    ...
    public static boolean updateR_Book(Long id){
        try{
            Connection connection = DbConnection.getConnection();
            PreparedStatement ps=connection.prepareStatement(
                    "update issued_returned_books set is_issued=? where student_id=? and book_id = ?");
